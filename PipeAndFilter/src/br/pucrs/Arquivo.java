...
public class Arquivo {
	...
	//Caminho para leitura e escrita dos arquivos
	private static final String PATH = "C:\\cs\\";
	...
	public static void salvarSaida(String fileName, HashMap<String, ArrayList<Integer>> map) {
		try (Writer writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(PATH + fileName + "-xref.txt"), "utf-8"))) {
